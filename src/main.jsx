...
const tools = [
  ...
  { id: 'word-to-pdf', name: 'Word to PDF', icon: FileType, description: 'Create polished PDFs from Word documents.', accept: '.doc,.docx', live: false },
  { id: 'pdf-to-jpg', name: 'PDF to JPG', icon: FileImage, description: 'Export crisp page images in seconds.', accept: '.pdf,application/pdf', live: false },
  ...
  { id: 'merge-pdf', name: 'Merge PDF', icon: Layers3, description: 'Join multiple files in the right order.', accept: '.pdf,application/pdf', live: true },
  ...
  { id: 'compress-pdf', name: 'Compress PDF', icon: FileArchive, description: 'Shrink files without visible quality loss.', accept: '.pdf,application/pdf', live: false },
  { id: 'edit-pdf', name: 'Edit PDF', icon: FilePenLine, description: 'Annotate, sign, and update content.', accept: '.pdf,application/pdf', live: false },
  { id: 'protect-pdf', name: 'Protect PDF', icon: FileLock2, description: 'Add passwords and permission rules.', accept: '.pdf,application/pdf', live: false },
  { id: 'unlock-pdf', name: 'Unlock PDF', icon: Lock, description: 'Remove access restrictions securely.', accept: '.pdf,application/pdf', live: false },
  ...
  { id: 'add-watermark', name: 'Add Watermark', icon: Droplets, description: 'Brand files with text watermarks.', accept: '.pdf,application/pdf', live: true },
  { id: 'ocr-pdf', name: 'OCR PDF', icon: Sparkles, description: 'Recognize scanned text with AI.', accept: '.pdf,application/pdf', live: false },
  { id: 'pdf-to-excel', name: 'PDF to Excel', icon: FileSpreadsheet, description: 'Pull tables into spreadsheet format.', accept: '.pdf,application/pdf', live: false },
  { id: 'excel-to-pdf', name: 'Excel to PDF', icon: FileOutput, description: 'Publish clean PDF reports from sheets.', accept: '.xls,.xlsx', live: false },
  { id: 'pdf-to-powerpoint', name: 'PDF to PowerPoint', icon: Play, description: 'Convert pages into editable slides.', accept: '.pdf,application/pdf', live: false },
  { id: 'powerpoint-to-pdf', name: 'PowerPoint to PDF', icon: FileInput, description: 'Package slide decks as PDFs.', accept: '.ppt,.pptx', live: false },
];
